...
public class AutoBottomBlue extends OpMode {
    ...
    public void init() {
        ...
        follower.setStartingPose(new Pose(56.052788601746855, 8.125608592549435, Math.toRadians(180)));
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            Start = follower.pathBuilder()
                    .addPath(
                            new BezierLine(
                                    new Pose(56.053, 8.126),
                                    new Pose(9.353, 12.451)
                            )
                    )
