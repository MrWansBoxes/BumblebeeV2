...
@Configurable
@TeleOp
public class RedBottomTeleOp extends OpMode {
    ...
    private static final Pose DEFAULT_STARTING_POSE = new Pose(106.461, 9.183, Math.toRadians(0));
    ...
    public void loop() {
        ...
        if (gamepad2.xWasPressed()) {
            follower.setX(8.301542776998598);
